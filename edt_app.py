...
# =============================================================================
    ...
    # ─── Imports communs (placés une seule fois en haut du fichier) ───
    import io
    ...
    # ═══════════════════════════════════════════════════════════════════════
        ...
        if not df_f.empty:
            ...
            if PDF_AVAILABLE:
                ...
                elements = [Paragraph(f"📚 EDT Enseignant : {cible}", title_style), Spacer(1, 10*mm), table]
                doc.build(elements)
